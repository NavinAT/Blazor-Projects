...
namespace BlazorAppBindingByDatatable
{
	public class SqlTable
	{
		...
		{
			using(SqlConnection connection = new SqlConnection("Data Source=MS-00603;Initial Catalog=BlazorEducation;User ID=sa;Password=password-123"))
			{
